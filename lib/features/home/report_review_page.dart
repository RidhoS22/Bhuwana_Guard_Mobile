...
class ReportReviewPage extends StatefulWidget {
  ...
  @override
  State<ReportReviewPage> createState() =>
      _ReportReviewPageState();
}

class _ReportReviewPageState
    extends State<ReportReviewPage> {
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      ...
                                      "${widget.longitude.toStringAsFixed(4)}° E",
